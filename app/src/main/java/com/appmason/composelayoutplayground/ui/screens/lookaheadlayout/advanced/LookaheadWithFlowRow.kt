        ...
        Column(
            ...
            FlowRow(
                ...
                Box(
                    Modifier
                        .height(50.dp)
                        .fillMaxWidth(animateFloatAsState(if (isHorizontal) 0.4f else 1f, label = "").value)
                        .background(colors[0], RoundedCornerShape(10))
                )
                Box(
                    Modifier
                        .height(50.dp)
                        .fillMaxWidth(animateFloatAsState(if (isHorizontal) 0.2f else 0.4f, label = "").value)
                        .background(colors[1], RoundedCornerShape(10))
                )
                Box(
                    Modifier
    ...
    LookaheadScope {
        FlowRow(
            ...
            Box(
                ...
                val height = animateDpAsState(targetValue = if (expanded) 500.dp else 300.dp, label = "")
                Box(
                    modifier = Modifier
                        .animateBounds(
                            Modifier
