 ...
 */
package com.appmason.composelayoutplayground.ui.screens.lookaheadlayout.components
...
fun InfiniteTransition.PulsingDot(startOffset: StartOffset) {
    val scale by animateFloat(
        0.2f,
        1f,
        infiniteRepeatable(tween(600), RepeatMode.Reverse, initialStartOffset = startOffset), label = ""
    )
    Box(
